...
const ignoredGlobalAnchors = [
  ...
  'meram profesyonel taşımacılık', 'meram profesyonel tasimacilik',
  ...
  'eregli uygun fiyatlı nakliyat', 'eregli uygun fiyatli nakliyat',
  'eregli asansörlü ev taşıma', 'eregli asansorlu ev tasima',
  ...
  'karatay evden eve nakliyat', 'karatay evden eve nakliyat',
  'asansörlü nakliyat', 'asansorlu nakliyat',
  'meram evden eve nakliyat', 'meram evden eve nakliyat',
  'selcuklu evden eve nakliyat', 'selcuklu evden eve nakliyat',
  'eregli evden eve nakliyat', 'eregli evden eve nakliyat',
