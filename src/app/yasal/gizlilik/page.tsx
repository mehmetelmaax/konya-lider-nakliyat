...
export const metadata: Metadata = {
  title: 'Gizlilik Politikası | Lider Nakliyat',
    ...
    <main className="min-h-screen bg-off-white text-charcoal py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto bg-white p-8 border border-gray-light rounded-xl shadow-sm space-y-6">
        ...
        <div className="space-y-4 text-sm text-charcoal">
          <h2 className="font-display font-bold text-forest text-lg">1. Güvenlik ve Veri Saklama</h2>
          ...
          <h2 className="font-display font-bold text-forest text-lg">2. Çerez Kullanımı</h2>
          <p className="leading-relaxed">
          ...
          <h2 className="font-display font-bold text-forest text-lg">3. İletişim Bilgileri</h2>
          <p className="leading-relaxed">
            Gizlilik politikalarımız hakkında daha fazla bilgi almak veya verilerinizin silinmesini talep etmek için doğrudan <a href={`mailto:${SITE.email}`} className="text-gold-text hover:underline">{SITE.email}</a> e-posta adresi üzerinden veri sorumlusu ile iletişime geçebilirsiniz.
          </p>
        </div>
      </div>
    </main>
