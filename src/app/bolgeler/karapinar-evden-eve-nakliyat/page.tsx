...
export const metadata: Metadata = {
  title: 'Karapınar Evden Eve Nakliyat | Lider Nakliyat',
  description: "Konya Karapınar ilçesinde kapalı kasa araçlarımızla sigortalı ve asansörlü evden eve nakliyat.",
  alternates: {
    canonical: '/bolgeler/karapinar-evden-eve-nakliyat',
  },
  robots: {
    index: false,
    follow: true,
...
export default function KarapinarPage() {
  const sss = [
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Karapınar Evden Eve Nakliyat',
        description: "Konya Karapınar ilçesinde kapalı kasa araçlarımızla sigortalı ve asansörlü evden eve nakliyat.",
        slug: 'bolgeler/karapinar-evden-eve-nakliyat',
        areaName: 'Karapınar'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Karapınar', url: '/bolgeler/karapinar-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ["Sandıklı","Fatih","Reşadiye","Hankapı","Zafer","Kale"];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Karapınar', url: '/bolgeler/karapinar-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Karapınar Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Karapınar ilçesinin tüm mahallelerinde K3 belgeli kapalı kasa araçlarımız, marangozlu nakliye ekiplerimiz ve dış cephe asansörlerimizle sabit fiyat garantili profesyonel taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm">
            ...
            <QuoteForm defaultDistrict="Karapınar" />
          </div>
