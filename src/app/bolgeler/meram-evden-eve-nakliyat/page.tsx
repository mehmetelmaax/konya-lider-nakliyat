...
export const metadata: Metadata = {
  title: 'Meram Evden Eve Nakliyat | Lider Nakliyat',
  description: "Konya Meram ilçesinde Havzan, Lalebahçe, Yaka ve Aşkan mahallelerinde asansörlü, sigortalı ve marangozlu evden eve nakliyat.",
  alternates: {
    canonical: '/bolgeler/meram-evden-eve-nakliyat',
  },
  robots: {
    index: true,
    follow: true,
...
export default function MeramPage() {
  const sss = [
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Meram Evden Eve Nakliyat',
        description: "Konya Meram ilçesinde Havzan, Lalebahçe, Yaka ve Aşkan mahallelerinde asansörlü, sigortalı ve marangozlu evden eve nakliyat.",
        slug: 'bolgeler/meram-evden-eve-nakliyat',
        areaName: 'Meram'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Meram', url: '/bolgeler/meram-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ["Havzan","Lalebahçe","Aşkan","Yaka","Melikşah","Kovanağzı","Kürden","Dere","Gödene","Harmancık"];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Meram', url: '/bolgeler/meram-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Meram ilçesinin tüm mahallelerinde K3 belgeli kapalı kasa araçlarımız, marangozlu nakliye ekiplerimiz ve dış cephe asansörlerimizle sabit fiyat garantili profesyonel taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm">
            ...
            <QuoteForm defaultDistrict="Meram" />
          </div>
