...
export const metadata: Metadata = {
  title: 'Ilgın Evden Eve Nakliyat | Lider Nakliyat',
  description: "Konya Ilgın ilçesinde kapalı kasa araçlarımızla sigortalı, asansörlü ve marangozlu ev taşıma hizmetleri.",
  alternates: {
    canonical: '/bolgeler/ilgin-evden-eve-nakliyat',
  },
  robots: {
    index: true,
    follow: true,
...
export default function IlginPage() {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Ilgın Evden Eve Nakliyat',
        description: "Konya Ilgın ilçesinde kapalı kasa araçlarımızla sigortalı, asansörlü ve marangozlu ev taşıma hizmetleri.",
        slug: 'bolgeler/ilgin-evden-eve-nakliyat',
        areaName: 'Ilgın'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Ilgın', url: '/bolgeler/ilgin-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ["Ilıca","Fatih","Şıhcarullah","Milli Egemenlik","Camiatik","Ayas"];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Ilgın', url: '/bolgeler/ilgin-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Ilgın Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Ilgın ilçesinin tüm mahallelerinde K3 belgeli kapalı kasa araçlarımız, marangozlu nakliye ekiplerimiz ve dış cephe asansörlerimizle sabit fiyat garantili profesyonel taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm">
            ...
            <QuoteForm defaultDistrict="Ilgın" />
          </div>
