...
export const metadata: Metadata = {
  title: 'Çumra Evden Eve Nakliyat | Lider Nakliyat',
  description: "Konya Çumra ilçesinde K3 belgeli kapalı kasa araçlarımızla asansörlü ve sigortalı evden eve nakliyat.",
  alternates: {
    canonical: '/bolgeler/cumra-evden-eve-nakliyat',
  },
  robots: {
    index: true,
    follow: true,
...
export default function ÇumraPage() {
  const sss = [
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Çumra Evden Eve Nakliyat',
        description: "Konya Çumra ilçesinde K3 belgeli kapalı kasa araçlarımızla asansörlü ve sigortalı evden eve nakliyat.",
        slug: 'bolgeler/cumra-evden-eve-nakliyat',
        areaName: 'Çumra'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Çumra', url: '/bolgeler/cumra-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ["İzzetbey","Bardakçı","Meydan","Yenimahalle","Bağlar","Bakkalbaşı"];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Çumra', url: '/bolgeler/cumra-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Çumra Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Çumra ilçesinin tüm mahallelerinde K3 belgeli kapalı kasa araçlarımız, marangozlu nakliye ekiplerimiz ve dış cephe asansörlerimizle sabit fiyat garantili profesyonel taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm">
            ...
            <QuoteForm defaultDistrict="Çumra" />
          </div>
