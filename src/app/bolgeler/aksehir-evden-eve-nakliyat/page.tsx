...
export const metadata: Metadata = {
  title: 'Akşehir Evden Eve Nakliyat | Lider Nakliyat',
  description: "Konya Akşehir ilçesinde sigortalı, asansörlü, sözleşmeli evden eve nakliyat ve parça eşya taşıma tır seferleri.",
  alternates: {
    canonical: '/bolgeler/aksehir-evden-eve-nakliyat',
  },
  robots: {
    index: true,
    follow: true,
...
export default function AksehirPage() {
  const sss = [
    {
  ...
  const schemas = {
    ...
    '@graph': [
      serviceSchema({
        name: 'Akşehir Evden Eve Nakliyat',
        description: "Konya Akşehir ilçesinde sigortalı, asansörlü, sözleşmeli evden eve nakliyat ve parça eşya taşıma tır seferleri.",
        slug: 'bolgeler/aksehir-evden-eve-nakliyat',
        areaName: 'Akşehir'
      }),
      breadcrumbSchema([
        { name: 'Ana Sayfa', url: '/' },
        { name: 'Bölgelerimiz', url: '/bolgeler' },
        { name: 'Akşehir', url: '/bolgeler/aksehir-evden-eve-nakliyat' }
      ]),
      faqSchema(sss)
    ]
  };

  const mahalleler = ["İstasyon","Yarenler","Seyran","Yeni Mahalle","Gazi","Kileci"];
  ...
  return (
    <>
      ...
      <main className="pt-24 bg-off-white">
        <Breadcrumb items={[{ name: 'Bölgelerimiz', url: '/#ilcelerimiz' }, { name: 'Akşehir', url: '/bolgeler/aksehir-evden-eve-nakliyat' }]} className="pt-4" />
        ...
        <section className="py-20 bg-navy text-white text-center space-y-4">
          ...
          <h1 className="font-display font-black text-3xl md:text-5xl tracking-tight leading-tight">
            Akşehir Evden Eve Nakliyat
          </h1>
          <p className="text-gray-300 text-sm md:text-base max-w-2xl mx-auto leading-relaxed px-4">
            Akşehir ilçesinin tüm mahallelerinde K3 belgeli kapalı kasa araçlarımız, marangozlu nakliye ekiplerimiz ve dış cephe asansörlerimizle sabit fiyat garantili profesyonel taşıma çözümleri sunuyoruz.
          </p>
        </section>
        ...
        <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-4">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              ...
              <span>Güvenilir Akşehir Nakliye Çözümleri</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Konya Lider Nakliyat olarak, Akşehir bölgesindeki ev taşıma ihtiyaçlarınıza kurumsal ve sigortalı çözümler üretiyoruz. Eşyalarınızın tamamını çift kat balonlu havalı naylonlarla ambalajlıyor, mobilyalarınızın söküm ve montaj işlerini kadrolu marangozlarımızla tamamlıyoruz. Yazılı ve imzalı sözleşmemiz sayesinde anlaştığımız fiyat taşınma günü asla değişmez, bütçeniz güvence altında kalır.
            </p>
          </div>

          <PricingMatrix />
          <BuildingAnalysis districtName="Akşehir" />
          <RelatedLinks currentSlug="aksehir-evden-eve-nakliyat" type="bolge" />

          {/* Section 2: Mahalleler */}
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6">
            <h2 className="font-display font-bold text-navy text-xl md:text-2xl flex items-center gap-2">
              <MapPin className="w-6 h-6 text-orange" />
              <span>Akşehir'da Hizmet Verdiğimiz Mahalleler</span>
            </h2>
            <p className="text-charcoal text-sm md:text-base leading-relaxed">
              Akşehir ilçesinin dört bir yanına ayrım yapmaksızın hızlı ve güvenilir nakliye tır ve kamyonetlerimizi sevk ediyoruz. Bölgede yoğun olarak hizmet verdiğimiz mahalleler:
            </p>
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm">
            ...
            <QuoteForm defaultDistrict="Akşehir" />
          </div>
