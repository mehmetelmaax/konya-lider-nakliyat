...
export default function K3InfoBlock({ licenseNumber }: K3InfoBlockProps) {
  return (
    <div className="bg-white p-8 rounded-xl border border-gray-light shadow-sm space-y-6 text-charcoal">
      ...
      {licenseNumber && (
        <div className="bg-orange/10 border border-orange/20 rounded-xl p-4 text-xs font-bold text-navy">
          Konya Lider Nakliyat yasal U-NET kayıtlı K3 Yetki Belge Numarası: <span className="text-orange-text underline">{licenseNumber}</span>
        </div>
      )}
      ...
      <div className="space-y-3">
        <span className="font-bold text-navy text-sm block">Taşımacılık Yetki Belgesi Tipleri Karşılaştırması</span>
          ...
          <table className="w-full text-left border-collapse text-xs md:text-sm">
            ...
            <tbody className="divide-y divide-gray-light">
              <tr className="hover:bg-off-white/50">
                <th scope="row" className="p-2.5 font-bold text-navy">K1 Belgesi</th>
              ...
              <tr className="hover:bg-off-white/50">
                <th scope="row" className="p-2.5 font-bold text-navy">K2 Belgesi</th>
                <td className="p-2.5">Sadece firmanın kendi öz malı olan eşya taşımacılığı</td>
                <td className="p-2.5 text-rose-500 font-bold">Ev eşyası taşıyamaz</td>
              </tr>
              <tr className="hover:bg-off-white/50">
                <th scope="row" className="p-2.5 font-bold text-navy">K3 Belgesi</th>
