...
export default function Footer() {
  ...
  const mainRegions = [
    ...
    { name: 'Meram', href: '/bolgeler/meram-evden-eve-nakliyat' },
    { name: 'Karatay', href: '/bolgeler/karatay-evden-eve-nakliyat' },
    { name: 'Ereğli', href: '/bolgeler/eregli-evden-eve-nakliyat' },
    { name: 'Akşehir', href: '/bolgeler/aksehir-evden-eve-nakliyat' },
  ];
  ...
  const allRegions = [
    ...
    { name: 'Ereğli', href: '/bolgeler/eregli-evden-eve-nakliyat' },
    { name: 'Akşehir', href: '/bolgeler/aksehir-evden-eve-nakliyat' },
    { name: 'Seydişehir', href: '/bolgeler/seydisehir-evden-eve-nakliyat' },
    ...
    { name: 'Cihanbeyli', href: '/bolgeler/cihanbeyli-evden-eve-nakliyat' },
    { name: 'Kadınhanı', href: '/bolgeler/kadinhani-evden-eve-nakliyat' },
  ];

  return (
    <footer className="bg-forest text-white border-t border-white/5 pt-16 pb-8" id="iletisim-footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <nav aria-label="Footer Hizmet Linkleri">
              <ul className={`space-y-2 text-xs md:text-sm text-gray-300 font-semibold mt-4 lg:mt-0 ${servicesOpen ? 'block' : 'hidden lg:block'}`}>
                <li>
                  <Link href="/hizmetler/sehirici-evden-eve-nakliyat" className="hover:text-gold transition-colors">1. Şehiriçi Evden Eve Nakliyat</Link>
                </li>
                <li>
                  <Link href="/hizmetler/sehirlerarasi-evden-eve-nakliyat" className="hover:text-gold transition-colors">2. Şehirlerarası Evden Eve Nakliyat</Link>
                </li>
                <li>
                  <Link href="/hizmetler/asansorlu-evden-eve-nakliyat" className="hover:text-gold transition-colors">3. Asansörlü Evden Eve Nakliyat</Link>
                </li>
                <li>
                  <Link href="/hizmetler/ofis-ve-isyeri-tasimaciligi" className="hover:text-gold transition-colors">4. İşyeri ve Ofis Taşıma</Link>
                </li>
                <li>
                  <Link href="/hizmetler/profesyonel-esya-paketleme" className="hover:text-gold transition-colors">5. Profesyonel Eşya Paketleme</Link>
                </li>
                <li>
                  <Link href="/hizmetler/ucretsiz-ekspertiz" className="hover:text-gold transition-colors">6. Ücretsiz Ekspertiz</Link>
                </li>
                <li>
                  <Link href="/hizmetler/esya-depolama" className="hover:text-gold transition-colors">7. Kiralık Eşya Depolama</Link>
                </li>
                <li>
                  <Link href="/hizmetler/parca-esya-tasima" className="hover:text-gold transition-colors">8. Parça Eşya Taşıma</Link>
                </li>
                <li>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <nav aria-label="Footer Bölge Linkleri">
              ...
              <div className="hidden lg:grid grid-cols-2 gap-x-4 gap-y-2 text-xs text-gray-300 font-semibold">
                <Link href="/hizmetler/sehirlerarasi-evden-eve-nakliyat" className="text-gold hover:underline col-span-2 font-bold">→ Şehirlerarası Taşımacılık</Link>
                <Link href="/rotalar" className="text-gold hover:underline col-span-2 border-b border-white/10 pb-1 font-bold">→ Şehirlerarası Lojistik Rotalar</Link>
                {allRegions.map((reg, idx) => (
                  <Link key={idx} href={reg.href} className="hover:text-gold transition-colors">{reg.name}</Link>
                ))}
              </div>
              ...
              <div className={`lg:hidden mt-4 ${regionsOpen ? 'block' : 'hidden lg:block'}`}>
                <div className="space-y-3">
                  <Link href="/hizmetler/sehirlerarasi-evden-eve-nakliyat" className="text-gold hover:underline block pb-1 font-bold text-xs border-b border-white/5">→ Şehirlerarası Taşımacılık</Link>
                  <Link href="/rotalar" className="text-gold hover:underline block pb-1 font-bold text-xs border-b border-white/5">→ Şehirlerarası Lojistik Rotalar</Link>
                  ...
                  <Link
                    href="/bolgeler"
                    className="mt-3 text-gold hover:underline text-xs font-bold flex items-center gap-1.5 justify-center bg-white/5 py-2.5 rounded-xl border border-white/10"
                  >
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-4 text-xs md:text-sm text-gray-300 pt-2 lg:pt-0">
              ...
              <a 
                ...
                className="flex gap-2 items-center hover:text-gold transition-colors font-bold"
              >
                <Phone className="w-4 h-4 text-gold" />
                <span>{SITE.phoneDisplay}</span>
              </a>
              <a href={`mailto:${SITE.email}`} className="flex gap-2 items-center hover:text-gold transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-4 text-xs text-gray-400 font-semibold pb-[env(safe-area-inset-bottom)] border-t border-white/5">
          ...
          <div className="text-center md:text-left">
            &copy; {currentYear} Konya Lider Nakliyat. Tüm hakları saklıdır. K3 Yetki Belgesi ile Hizmet Vermekteyiz.
          </div>
